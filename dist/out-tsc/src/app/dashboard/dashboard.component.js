...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        myChart = new chart_js_1.default(this.ctx, {
            type: 'bar',
            data: {
        ...
        chart_js_1.default.pluginService.register({
        ...
        var myChart = new chart_js_1.default(this.ctx, {
            type: 'line',
            data: {
        ...
        var viewsChart = new chart_js_1.default(this.ctx, a);
        var mapData = {
            "AU": 760,
            "BR": 550,
            "CA": 120,
